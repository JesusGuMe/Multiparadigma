# conecta 4
# # el jugador 1 va a ser "O" y el segundo "X"
# # tablero de 6 x 7# se debe visualizar el recorrido de las fichas
# # el jugador debe elegir la columna donde quiere su ficha# gana el primero que agrupe 
# cuatro fichas en horizontal vertical y diagonal si se acaba el espacio en el tablero
# es empate de lo contrario mostrar al ganador.
# Cambio: Solamente verificar en vertical
import random
